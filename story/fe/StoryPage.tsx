// Story 탭의 실제 화면. (담당: 하은)
// 라우팅 파일(apps/web/app/(domains)/story/page.tsx)은 이 컴포넌트를 불러다 렌더링만 하므로,
// 화면 작업은 이 폴더(story/fe) 안에서만 하면 된다.
//
// 지금 여기 뜨는 것은 haeun/landing 의 랜딩 프로토타입이다 — 순수 HTML/CSS/JS 라
// React 로 옮기지 않고 그대로 띄운다. 파일은 story/fe/sync-landing.sh 가
