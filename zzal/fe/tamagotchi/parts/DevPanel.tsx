...
//
// ★ 이 패널을 그릴지는 부름 쪽(Scrapbook)이 `useDevPanelVisible` 로 정한다 —
//   **로컬이고** 주소에 `?dev=1` 이 있을 때만. 로컬 밖(운영·dev.lorecomic.com 등)에서는 안 그린다.
// ★ 설령 떠서 눌러도 아무 일이 안 난다 — dev 주소는 `ZZAL_DEV_TOOLS=true` 인 서버에만 있다.
//   화면 게이트는 편의고, 자물쇠는 서버다.
