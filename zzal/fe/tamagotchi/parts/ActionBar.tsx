...
// 버튼 일곱 개는 첫 순간부터 **자리에** 다 있다(정본 §0 원칙 7) — 사라지지 않고 흐려지기만 한다.
// 튜토리얼이 끝난 뒤에는 부름이 강조만 하고 잠그지 않는다.
// ★ 튜토리얼 중에는 반대다(정본 v1.10 §12) — 「지금 안내(강조)된 버튼만 누를 수 있다 — 나머지는 잠긴다」.
//   그 판정은 `useTamagotchi.can()` 한 곳에만 있다. 여기서 다시 세지 않는다.
