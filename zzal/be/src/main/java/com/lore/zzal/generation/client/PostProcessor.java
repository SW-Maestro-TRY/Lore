 ...
 * ★ <b>버전을 세션마다 받는다</b> — 빈이 만들어질 때의 설정 버전이 아니라 <b>그 job 의 버전</b>으로
 *   스크립트와 출력 이름을 고른다. 옛 기록을 이어 구울 때 그 job 이 적어 둔 버전을 그대로 써야 한다.
 *
 * <h3>★★ 왜 세션인가 — 1층과 2층이 <b>같은 작업 폴더</b>를 써야 한다</h3>
 * 후처리는 그림 옆에 {@code anchors.json} 을 같이 낸다. 1층 호출이 그 파일을 만들고 2층 호출이
...
public interface PostProcessor {
    ...
    interface Session extends AutoCloseable {
         ...
         * ★ 자세 매핑 파일이 없는 버전은 빈 문자열이 오고, 그때는 인자를 아예 안 넘긴다.
         *
