...
public record UnlockRule(Kind kind, int target) {
    ...
    public enum Kind {
        ...
        BATH,
        /**
         * 미니게임 <b>끝까지 친 매치</b> 수(승패·종류 무관).
         *
         * ★ 이름이 {@code STARTS} 인 것은 옛 규칙의 흔적이다 — 2026-09-22 결정으로 기권·강제 종료한
         *   매치를 빼고 <b>완주</b>만 센다({@code ZzalPet.finishGame()}). 시작으로 세던 때는
         *   시작·나가기를 되풀이해 열 수 있었다. 사용자에게 보이는 문구("미니게임 4판")는 그대로다 —
         *   "판" 은 한 매치이고 그 뜻이 달라지지 않았다.
         */
        GAME_STARTS,
        /** 밥 준 횟수(누적). */
        FEEDS,
