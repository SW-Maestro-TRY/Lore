...
public class GameService {
    ...
    public GuessResult guess(Long userId, Long petId, Long gameId, char pick, Instant realNow) {
        ...
        // ★★ 놀이 조각은 <b>완주한 매치</b>만 센다 — 승패가 갈려 판이 끝난 그 순간(3승 또는 3패), 승패는 안 본다
        ...
        //
        // ★★ 이 조건이 정본이다(2026-09-22 상훈님 결정) — <b>튜토리얼 뒤 좌우 맞히기 완주 패배</b>.
        //   옛 정본은 "함께한 날 3일 + 그날 케어 미스 0" 이었고 서버는 처음부터 첫 패배로 돌고 있었다.
        //   갈림을 <b>코드 쪽으로</b> 닫았다 — 진 자리에서 위로가 오는 편이 이야기에 맞기 때문이다
        //   (연결 감사 J2). 그 결정으로 쓰이지 않던 {@code ZzalRules.SECOND_GIFT_AFTER_ADVANCED}(=8,
        //   "3층 심화 8종이 열린 뒤")도 함께 지웠다 — 남겨 두면 옛 규칙이 살아 있는 것처럼 읽힌다.
        //
