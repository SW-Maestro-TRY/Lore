...
- **하루 20줄**이며 그 "하루"는 **취침 기준**이다(2026-09-22 개정, 옛 한국 시각 자정은 폐기). 다른 상한(놀이 3판·간식·쓰다듬·목욕)과 같은 경계다 — **마지막 밤잠 기상부터 다음 기상까지**이고, 자정을 넘겨도 잠들기 전이면 같은 하루다. 낮잠은 경계가 아니다. 경계가 갈려 있던 때는 자정을 낀 늦은 밤에 **한 번 깨어 있는 사이에 상한이 두 번 풀렸다**.
