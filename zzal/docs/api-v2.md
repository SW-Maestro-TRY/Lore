...
| 41 | 2 | 발병 시각·병 시간은 **조회 패턴과 무관**하다 — 정산이 "다음 사건까지만" 걷기 때문에, 세 시간 만에 한 번 보든 1초마다 보든 `sick.since`가 같다 |
...
- **2026-09-05** — PR-8(#198) 리뷰 반영(#225): 아기 60분 병 없음, 정산 간격과 무관한 발병 시각, 씨앗에 서버 비밀, 15번 진행도 감춤, 거절이 정산을 안 되돌림. 해석 39~42.
