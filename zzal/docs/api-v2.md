...
| 45 | 2 | 부재 4시간은 **깨어 있는 시간**이고 아기 60분도 센다. 밀린 청크가 3보다 많아도 **남는 것은 3컷**이고, 쓰고 남은 시간은 다음 컷으로 이월된다 |
| 46 | 2 | 밤 연습 장면은 잠든 그 시각으로 한 컷(같은 잠에 두 번 없음). **아프면 안 남긴다**(정본 16장 "아픈 동안 훈련 자세 거부"). 기능이 열리기 전(첫 부재 4시간 전)에도 안 남긴다 |
