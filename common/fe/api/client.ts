...
export type ApiErrorCode =
  ...
  | 'ZZAL_PET_RELEASE_NOT_ALLOWED'
  | 'ZZAL_CARE_NOT_NEEDED'
  | 'ZZAL_NO_FOOD'
  | 'ZZAL_NOT_SLEEP_TIME'
  | 'ZZAL_NOT_WAKE_TIME'
  | 'ZZAL_SICK_REFUSES'
  | 'ZZAL_BATH_DONE_TODAY'
  | 'ZZAL_CHAT_SLOT_CLOSED'
  | 'ZZAL_FEATURE_LOCKED'
  | 'ZZAL_TRAVELING'
  | 'ZZAL_NOT_TRAVELING'
  | 'ZZAL_MOTION_NOT_OPEN'
  | 'ZZAL_REGEN_NOT_REQUESTED'
  | 'ZZAL_GAME_NOT_FOUND'
  | 'ZZAL_GAME_FINISHED'
  | 'ZZAL_GAME_DAILY_LIMIT'
  | 'ZZAL_FEEDBACK_ALREADY_SUBMITTED'
  | 'ADMIN_ONLY'
  | (string & {});
