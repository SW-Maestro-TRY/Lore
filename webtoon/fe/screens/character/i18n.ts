...
const dict: Dict = {
  ...
  "아주 가끔, 넣은 것과 다른 종으로 태어나는 캐릭터가 있어요.": { en: "Once in a rare while, a character is born as a different species from what you put in.", ja: "ごくまれに、入れたものと違う種族で生まれるキャラクターがいます。", zh: "极少数情况下，角色会以和你输入的不同的物种诞生。" },
  "당황했어요": { en: "I was confused", ja: "戸惑いました", zh: "有点懵" },
  "괜찮았어요": { en: "It was fine", ja: "大丈夫でした", zh: "还不错" },
  "답해 주셔서 고마워요!": { en: "Thanks for answering!", ja: "ご回答ありがとうございます！", zh: "感谢你的回答！" },
  "이 카드를 공유해서 친구가 링크를 열면, 무료 기회를 1번 돌려드려요.": { en: "Share this card, and when a friend opens the link, you get 1 free try back.", ja: "このカードを共有して友だちがリンクを開くと、無料回数を1回お返しします。", zh: "分享这张卡片，朋友打开链接后，将返还你1次免费机会。" },
