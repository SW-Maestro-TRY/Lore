...
const FAQ: { q: string; a: string }[] = [
  ...
  { q: "만든 웹툰을 판매하거나 광고에 써도 되나요?", a: "개인적으로 간직하거나 **SNS에 올려 공유하는 것은 자유롭게** 하셔도 됩니다. 다만 결과물을 **팔거나, 굿즈·이모티콘 상품으로 만들거나, 광고에 쓰는 것은 지금은 허용되지 않아요.** AI가 만든 그림은 저작권이 인정되지 않을 수 있다는 점도 함께 알아 두시면 좋아요." },
  { q: "몇 살부터 쓸 수 있나요?", a: "**만 14세 이상**부터 이용하실 수 있어요. 회원 가입을 할 때 확인받습니다." },
];
