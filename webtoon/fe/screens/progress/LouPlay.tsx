...
/* 루와 놀기 — 기다리는 동안의 자리.
 *
 * 누르기·연달아 누르기·꾹 누르기·끌어당기기·잡고 흔들기(드래그 방향을 빨리
 * 뒤집기)에 루가 다르게 반응한다. 실제 기기를 흔드는 건 없다 — 권한 팝업까지
 * 띄우면서 얻는 재미보다 그 팝업의 거부감이 크다는 판단(mascotPlay.ts 참고).
 * 반응 프레임과 대사는 /static/lou/react/manifest.json, 아래에서 도는 팁은
 * /static/lou/tips.json 이 정한다 — 둘 다 그림 원본(webtoon/ai/assets/lou)에
 * 있어서, 반응이나 팁을 늘리는 데 이 파일을 고칠 일은 없다.
 *
