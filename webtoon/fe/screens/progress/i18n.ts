...
const dict: Dict = {
  ...
  "이야기 설계": { en: "Story design", ja: "ストーリー設計", zh: "故事设计" },
  "캐릭터에서 이야기를 만듭니다": { en: "Building a story from the character", ja: "キャラクターからストーリーを作ります", zh: "从角色出发构建故事" },
  "사진에서 외형 읽기": { en: "Reading looks from the photo", ja: "写真から外見を読む", zh: "从照片读取外形" },
  "장르·세계관 정하기": { en: "Choosing genre and world", ja: "ジャンル・世界観を決める", zh: "确定题材与世界观" },
  "캐릭터 카드 쓰기": { en: "Writing the character card", ja: "キャラクターカードを書く", zh: "撰写角色卡" },
  "이야기 뼈대 세우기": { en: "Outlining the story", ja: "ストーリーの骨組みを作る", zh: "搭建故事骨架" },
  "구조 검수": { en: "Structure check", ja: "構成の検査", zh: "结构检查" },
  "첫 장면 쓰기": { en: "Writing the first scene", ja: "最初の場面を書く", zh: "撰写第一幕" },
  "캐릭터 시트": { en: "Character sheet", ja: "キャラクターシート", zh: "角色设定图" },
  "컷마다 같은 얼굴이 나오도록 기준 그림을 만듭니다": { en: "Making a reference so every panel has the same face", ja: "どのコマでも同じ顔になるよう基準の絵を作ります", zh: "制作基准图，让每格都是同一张脸" },
  "외형 사양 정리": { en: "Organizing the look", ja: "外見の仕様を整理", zh: "整理外形规格" },
  "시트 그리기": { en: "Drawing the sheet", ja: "シートを描く", zh: "绘制设定图" },
  "기준 시트 확정": { en: "Confirming the reference sheet", ja: "基準シートを確定", zh: "确定基准设定图" },
  "회차 설계 · 콘티": { en: "Episode plan · storyboard", ja: "話の設計 · ネーム", zh: "本话设计 · 分镜" },
  "1화를 컷으로 나누고 대사를 붙입니다": { en: "Splitting episode 1 into panels and adding lines", ja: "第1話をコマに分けてセリフを付けます", zh: "把第 1 话分成分格并加上台词" },
  "큰 줄거리": { en: "Overall plot", ja: "大まかなあらすじ", zh: "整体剧情" },
  "1화 설계": { en: "Episode 1 plan", ja: "第1話の設計", zh: "第 1 话设计" },
  "연출 검사": { en: "Direction check", ja: "演出の検査", zh: "演出检查" },
  "컷 나누기": { en: "Splitting panels", ja: "コマ割り", zh: "分格" },
  "그림 그리기": { en: "Drawing", ja: "絵を描く", zh: "绘图" },
  "한 장에 3컷씩 그립니다 — 말풍선과 대사가 함께 들어갑니다": { en: "Three panels per page — speech bubbles and lines included", ja: "一枚に3コマずつ描きます — 吹き出しとセリフも一緒に入ります", zh: "每页画 3 格 — 对话框和台词一并加入" },
  "장면 서술 옮기기": { en: "Translating scene descriptions", ja: "場面の描写を移す", zh: "转写场景描述" },
  "3컷씩 묶기": { en: "Grouping into threes", ja: "3コマずつまとめる", zh: "每 3 格一组" },
  "장 그리기": { en: "Drawing pages", ja: "ページを描く", zh: "绘制页面" },
  "한 편으로 잇기": { en: "Joining into one episode", ja: "一話につなぐ", zh: "拼成一话" },
  "그린 장을 순서대로 세로로 이어 붙입니다": { en: "Stitching the pages vertically in order", ja: "描いたページを順に縦につなぎます", zh: "把画好的页面按顺序竖向拼接" },
  "이어 붙이기": { en: "Stitching", ja: "つなぎ合わせ", zh: "拼接" },
  ...
  "그린 장을 순서대로 이어 붙이고 마지막으로 살펴봅니다": { en: "Joins the pages in order and takes one last look", ja: "描いたページを順につなぎ、最後に確認します", zh: "按顺序拼接页面并做最后检查" },
  "장 순서 확인": { en: "Checking page order", ja: "ページ順の確認", zh: "检查页面顺序" },
  "세로로 이어 붙이기": { en: "Stitching vertically", ja: "縦につなぎ合わせる", zh: "竖向拼接" },
  "빠진 컷·글자 살펴보기": { en: "Checking for missing panels or text", ja: "抜けたコマ・文字の確認", zh: "检查是否漏格漏字" },
  ...
  "기다리는 동안 루를 눌러 보세요.": { en: "Try tapping Lou while you wait.", ja: "待っている間、Louを押してみてください。", zh: "等待时可以点点 Lou。" },
  ...
  "흔들기 켜기": { en: "Enable shake", ja: "振るを有効に", zh: "开启摇一摇" },
  "팁": { en: "Tip", ja: "ヒント", zh: "小贴士" },
  "진행 기록": { en: "Progress log", ja: "進行記録", zh: "进度记录" },
  "루가 하는 일이 여기 쌓여요": { en: "What Lou's doing, logged here", ja: "Louがしていることがここに溜まります", zh: "Lou 在做什么会记在这里" },
  "{n} / {total}장 그림 완성": { en: "Page {n} / {total} finished", ja: "{n} / {total}枚 完成", zh: "第 {n} / {total} 页完成" },
  ...
  "둘러보기 하며 기다리기": { en: "Explore while you wait", ja: "見て回りながら待つ", zh: "边浏览边等" },
